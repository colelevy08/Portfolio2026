...
[![Vercel](https://img.shields.io/badge/Live-Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://colelevy.vercel.app)
...
[**Live site**](https://colelevy.vercel.app) ·
...
<p align="center">
  <a href="https://colelevy.vercel.app">
...
| Target           | URL                                                   | How                                          |
| ---------------- | ----------------------------------------------------- | -------------------------------------------- |
| **Vercel** (primary) | https://colelevy.vercel.app                      | Auto-deploys on push to `main` (root path `/`)   |
...
- Pair-programmed end-to-end with **[Claude Code](https://www.anthropic.com/claude-code)** (Anthropic's CLI) — every section, animation, and the dual-deploy pipeline was iterated in-terminal with Claude as the co-pilot
