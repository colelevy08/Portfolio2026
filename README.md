...
[![Vercel](https://img.shields.io/badge/Live-Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://colelevy.dev)
...
| Target           | URL                                                   | How                                          |
| ---------------- | ----------------------------------------------------- | -------------------------------------------- |
| **Vercel** (primary) | https://colelevy.dev                      | Auto-deploys on push to `main` (root path `/`)   |
